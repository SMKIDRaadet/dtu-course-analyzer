                    ...
                    if participants >= 5:
                        ...
                        for j, grade in enumerate(grades):
                            ...
                            if (nppl != ''):
                                ...
                                if (grade!=grades[0]) or (grades!=grades[1]):

...
for i, course in enumerate(bachelor_courses):
    printlog("Analyzing course:" + course + " (" + i + "/" + len(courses) + ")")
            ...
            if resp.getcode()==200:
                ...
                if participants >= 5 :
                    ...
                    if len(lst) == 43:
                        ...
                        reviewsDB[reviews_success_counter].append(participants)
                        for ls in lst:
    ...
    if exams != "":
        ...
        printlog("Warning: Cannot formatt exam overview")
    printlog("")  
